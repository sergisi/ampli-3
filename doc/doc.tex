...
%S'han de renombrar totes, inclús date, si un camp es deixa en blanc no apareix
	...
	\makeatother
\title{Pràctica de Patrons de Disseny (v1)}
\author{Sergi Simón Balcells, Ian Palacin Aliana, Joaquim Picó Mora}
\date{Dilluns 11 de Maig}
\assignatura{Ampliació de BBDD i ES}
